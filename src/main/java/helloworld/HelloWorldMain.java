...
//        final Runnable enterPrinter = () -> System.out.print("!\n");
        ...
        ScheduledFuture<?> hello = scheduler.scheduleAtFixedRate(helloPrinter, 0, 10, TimeUnit.SECONDS);
        ScheduledFuture<?> world = scheduler.scheduleAtFixedRate(worldPrinter, 0, 10, TimeUnit.SECONDS);
